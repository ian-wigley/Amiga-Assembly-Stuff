...
;    ***********************************;
;    *        MEGA DEMO PART 1         *;
;    *     This intro was turned       *;
;    * into my last Amiga 500 demo ... *;
;    ***********************************;
;    *         Written in 1988.        *;
;    ***********************************;
...
colp:   
    dc.w    $0001,$0003,$0005,$0007,$0009
    dc.w    $0007,$0005,$0003,$0001
colx:   
    dc.w    $0110,$0330,$0550,$0770,$0990
    dc.w    $0770,$0550,$0330,$0110
...
; Add the copperlist
    include    Dev:Intro_Demo-Code/Intro_one/copperlist.asm
...
scrloop:
    ...
    bne     qq
    lea     text,a1
qq: move.l  a1,textadr
scrlend:
    movem.l    (a7)+,d0-d6/a0-a6
    rts

textadr:dc.l    text
ekschr: dc.b    "0123456789?!^:,.'()-/ ",0
...
wachrs:
    incbin "Dev:Intro_Demo-Code/Final_A500_Demo/wachr.raw"

data:
    incbin "Dev:Intro_Demo-Code/Final_A500_Demo/mod.shades"

logo:
    incbin "Dev:Intro_Demo-Code/Final_A500_Demo/lostboys1.logo"
