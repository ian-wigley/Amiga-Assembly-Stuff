...
scroll:
    subi.w   #$0011,$000306a8   ;000007d0 : 0479 0011 0003 06a8      subi.w   #$0011,$000306a8
    addi.w   #$0001,$00030bd8   ;000007d8 : 0679 0001 0003 0bd8      addi.w   #$0001,$00030bd8
    cmpi.w   #$0010,$00030bd8   ;000007e0 : 0c79 0010 0003 0bd8      cmpi.w   #$0010,$00030bd8
    beq      l1                 ;000007e8 : 6700 0004                beq      $000007ee
    rts                         ;000007ec : 4e75                     rts
l1:
    clr.w    $00030bd8          ;000007ee : 4279 0003 0bd8           clr.w    $00030bd8
    move.w   #$00ff,$000306a8   ;000007f4 : 33fc 00ff 0003 06a8      move.w   #$00ff,$000306a8 
    ...
    beq      $00000828          ;0000081e : 6700 0008                beq      $00000828
    jmp      $00030c48          ;00000822 : 4ef9 0003 0c48           jmp      $00030c48
...
l2:
    ...
    beq      $00000876          ;00000858 : 6700 001c                beq      $00000876
...
; duplicate code ?
    lea      $00039800,a0       ;00000876 : 41f9 0003 9800           lea      $00039800,a0
    jmp      $00030ca4          ;0000087c : 4ef9 0003 0ca4           jmp      $00030ca4
	lea      $00039800,a0       ;00000882 : 41f9 0003 9800           lea      $00039800,a0
    jmp      $00030ca4          ;00000888 : 4ef9 0003 0ca4           jmp      $00030ca4
l3:
    lea      $00039800,a0       ;0000088e : 41f9 0003 9800           lea      $00039800,a0
    lea      $00030de8,a2       ;00000894 : 45f9 0003 0de8           lea      $00030de8,a2
    jmp      $00030ca4          ;0000089a : 4ef9 0003 0ca4           jmp      $00030ca4
    rts                         ;000008a0 : 4e75                     rts
l4:
    lea      $00062830,a1       ;000008a2 : 43f9 0006 2830           lea      $00062830,a1
    move.b   (a0)+,(a1)+        ;000008a8 : 12d8                     move.b   (a0)+,(a1)+ 
    addi.w   #$0001,$00030be0   ;000008aa : 0679 0001 0003 0be0      addi.w   #$0001,$00030be0
    cmpi.w   #$0004,$00030be0   ;000008b2 : 0c79 0004 0003 0be0      cmpi.w   #$0004,$00030be0
    beq      l5                 ;000008ba : 6700 0008                beq      $000008c4
    jmp      $00030cdc          ;000008be : 4ef9 0003 0cdc           jmp      $00030cdc
l5:
	clr.w    $00030be0          ;000008c4 : 4279 0003 0be0           clr.w    $00030be0
    ...
    addi.w   #$0001,$00030bde   ;000008da : 0679 0001 0003 0bde      addi.w   #$0001,$00030bde
    cmpi.w   #$0020,$00030bde   ;000008e2 : 0c79 0020 0003 0bde      cmpi.w   #$0020,$00030bde
    beq      l6                 ;000008ea : 6700 0008                beq      $000008f4
    jmp      $00030cdc          ;000008ee : 4ef9 0003 0cdc           jmp      $00030cdc
l6:
	clr.w    $00030bde          ;000008f4 : 4279 0003 0bde           clr.w    $00030bde
    clr.w    $00030be0          ;000008fa : 4279 0003 0be0           clr.w    $00030be0
    ...
    addi.w   #$0001,$00030be0   ;00000914 : 0679 0001 0003 0be0      addi.w   #$0001,$00030be0
    cmpi.w   #$0004,$00030be0   ;0000091c : 0c79 0004 0003 0be0      cmpi.w   #$0004,$00030be0
    beq      l7                 ;00000924 : 6700 0008                beq      $0000092e
    jmp      $00030d46          ;00000928 : 4ef9 0003 0d46           jmp      $00030d46
l7:
	clr.w    $00030be0          ;0000092e : 4279 0003 0be0           clr.w    $00030be0
    ...
    addi.w   #$0001,$00030bde   ;00000944 : 0679 0001 0003 0bde      addi.w   #$0001,$00030bde
    cmpi.w   #$0020,$00030bde   ;0000094c : 0c79 0020 0003 0bde      cmpi.w   #$0020,$00030bde
    beq      l8                 ;00000954 : 6700 0008                beq      $0000095e
    jmp      $00030d46          ;00000958 : 4ef9 0003 0d46           jmp      $00030d46
l8:
	clr.w    $00030bde          ;0000095e : 4279 0003 0bde           clr.w    $00030bde
    clr.w    $00030be0          ;00000964 : 4279 0003 0be0           clr.w    $00030be0
